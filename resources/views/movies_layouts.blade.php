		...
		<div id="site-content">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							@if(session()->has('is_loggedin') == false)
                                ...
                                <li class="menu-item"><a href="{{ url('register') }}">{{__("messages.register")}}</a></li>
							@endif
							@if(session()->has('is_loggedin') == true)
								...
								<li class="menu-item"><a href="{{ url('review_movies') }}">{{ __("messages.review_movie") }}</a></li>
			...
			<footer class="site-footer">
				<div class="container" style="text-align:center">
					...
					{!! '<p class="">Copyright &copy;'. date('Y'). ' FilmVault - Tugas Besar Interoperabilitas</p>' !!}
				</div> <!-- .container -->
			</footer>
		</div>
