...
addToFavMovies = () => {
    ...
    $("form[name='addReviewForm']").on('submit', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("button[type='submit']").html("Submit Review");
...
addReview = () => {
    $("form[name='addReviewForm']").on('submit', function(e){
        ...
        var imdbId = $(this).find("input[name='movie_id']").val();
        var rating = $(this).find("input[name='rating']").val();
        var comment = $(this).find("textarea[name='comment']").val();

        $.ajax({
            url : url+'/api/reviews/store',
            type : 'POST',
            dataType : 'json',
            data : {
                movie_id: imdbId,
            ...
            beforeSend(){
                $("form[name='addReviewForm'] button[type='submit']").html("Submitting...");
                $("form[name='addReviewForm'] button[type='submit']").attr("disabled", true);
            },
            success:function(res){
                if(res.message === 'Review stored successfully'){
                    Toast.fire({
                    ...
                    // You can redirect or refresh the page after successful submission if needed
                ...
                $("form[name='addReviewForm'] button[type='submit']").html("Submit Review");
                $("form[name='addReviewForm'] button[type='submit']").attr("disabled", false);
            },
            error:function(jqueryXHR){
                Toast.fire({
                    type: 'error',
